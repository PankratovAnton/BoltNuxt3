<template>
  <article class="attraction-page">
    ...
    <section class="hero relative h-[60vh] min-h-[400px] overflow-hidden">
      <img src="/images/hidirlik-tower-seaside-perspective-olive-tree-in-antalya-kaleici-old-town-turkey.jpg" alt="Hidirlik Tower in Antalya" class="w-full h-full object-cover">
        ...
        <div class="mx-auto">
          <div>
            <InteractiveImage
              ...
              alt="Historical view of Hidirlik Tower"
      ...
      <section ref="ArchSection" class="content-section mb-16 bg-[#f5ede1] p-8 rounded-xl shadow-lg">
        ...
        <div class="grid md:grid-cols-2 gap-8 items-center">
          <div class="prose prose-lg max-w-none text-kaleici-700">
            ...
            <p class="indent-6 mb-4">{{ $t('hidirlikTower.modern2') }}</p>
            <p class="indent-6 mb-4">{{ $t('hidirlikTower.modern3') }}</p>
            <p class="indent-6">{{ $t('hidirlikTower.modern4') }}</p>
          </div>
          <div
          ...
          >
            <img
              ...
              alt="Architectural details of Hidirlik Tower"
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <NuxtLink :to="localePath('/karaalioglu-park')" class="bg-white rounded-lg shadow-lg overflow-hidden transform hover:scale-105 transition-all duration-300">
            <div class="h-48 overflow-hidden">
              <img src="/images/karaalioglu-park-in-Antalya-Kaleici-Old-Town-Turkey-1.jpg" alt="Karaalioglu Park in Antalya Kaleici" class="w-full h-full object-cover">
            </div>
            <div class="p-6">
          ...
          <NuxtLink :to="localePath('/hadrians-gate')" class="bg-white rounded-lg shadow-lg overflow-hidden transform hover:scale-105 transition-all duration-300">
            <div class="h-48 overflow-hidden">
              <img src="/images/hadrian-gate-in-Antalya-Kaleici-Old-Town-Turkey-1.jpg" alt="Hadrians Gate in Antalya Kaleici" class="w-full h-full object-cover">
            </div>
            <div class="p-6">
          ...
          >
            ...
            <div class="prose prose-base text-kaleici-700 leading-relaxed">
              ...
              <ul class="list-disc pl-5">
                <li>{{ $t('hidirlikTower.bestTime_text') }}</li>
              </ul>
              <h3 class="text-xl font-semibold mt-6 mb-2">
                {{ $t('hidirlikTower.photographyTips_title') }}
              </h3>
              <ul class="list-disc pl-5">
                <li>{{ $t('hidirlikTower.photographyTips_text') }}</li>
              </ul>
              <h3 class="text-xl font-semibold mt-6 mb-2">
                {{ $t('hidirlikTower.refreshments_title') }}
              </h3>
              <ul class="list-disc pl-5">
                <li>{{ $t('hidirlikTower.refreshments_text') }}</li>
              </ul>
            </div>
          </div>
          <!-- Image block -->
  ...
  <div class="grid md:grid-cols-2 gap-8 items-stretch">
    ...
    <div class="flex flex-col justify-between space-y-8 h-full">
      ...
      <InteractiveImage
        ...
        alt="Visitor facilities near Hidirlik Tower"
        class="rounded-xl"
      />
      <iframe
        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3190.6725431851424!2d30.703145776279144!3d36.88272447210611!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14c39009259f7e4f%3A0x8b1817aa2e5f733a!2sH%C4%B1d%C4%B1rl%C4%B1k%20Tower!5e0!3m2!1sen!2sus!4v1699453523018!5m2!1sen!2sus"
...
useSeoMeta({
  ...
  description: 'Explore the history, architecture, and secrets of Hidirlik Tower in Antalya Kaleiçi with tips, photos, and more.',
  ogTitle: 'Hidirlik Tower in Antalya — Complete Guide',
  ogDescription: 'See photos and learn about Hidirlik Tower in Kaleiçi, Antalya.',
  ogImage: '/images/hidirlik-tower-og.jpg',
